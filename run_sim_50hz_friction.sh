...
python main_ddpg.py --config ./config/real_ddpg++/sim_50hz_low_friction.json --id sim_ddpg++_50hz_low_friction --gpu --force &
python main_ddpg.py --config ./config/real_ddpg++/sim_50hz_high_friction.json --id sim_ddpg++_50hz_high_friction --gpu --force &
